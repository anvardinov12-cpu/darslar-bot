...
async def start_add_lesson(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "`YYYY-MM-DD HH:MM`\n\n"
        "Agar moslab yozishda qiyinchilikka uchrasangiz, formatni ko'chirib olib darslaringiz ro'yxati va formatni biror AI chatda yuboring, undan darslar orasiga `---` qo'yib shu formatga moslab berishini so'rang. 1-2 soniyada formatlab beradi, so'ng tayyor formatni shuyerga yuboring."
    )
